...
- 2025-06-19 : version 1.17 (switch to Java 21, update dep links with Sonatype, update Gson 2.13.1 and SLF4J 2.0.17, improve Router API for method chaining)
- 2025-06-21 : version 1.18 (cleanup directory and fix some warnings in Java 21)
